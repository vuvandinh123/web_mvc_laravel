...
@section('title', 'Admin | Thùng rác trang')

@section('crumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="{{ route('dashboard') }}">Admin</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Thùng rác trang</li>
        </ol>
    </nav>
@endsection
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <h6 class="fs-4 text-capitalize text-danger">Thùng rác trang</h6>
                        <div></div>
                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src=@if (is_file('images/pages/' . $page->image)) {{ asset('images/pages/' . $page->image) }}
                                                        @else 
                                                            {{ $page->image }} @endif
                                            ...
                                            <td class="align-middle">
                                                <span style="cursor: pointer" data-id="{{ $page->id }}"
                                            ...
                                            <td class="align-middle ">
                                                <a class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip" data-original-title="Edit user">
                                                    <input class="destroys" type="checkbox" value="{{ $page->id }}"
                                                        name="" id="">
                                                </a>
                                            </td>
                                        </tr>
