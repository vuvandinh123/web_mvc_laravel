                ...
                <div class="card-body">
                  <form action="{{ route('admin.postlogin') }}" method="POST" id="create" role="form">
                    ...
                    <div class="mb-3">
                      ...
                      <span style="font-size: 13px" class="text-danger alert"></span>
                    </div>
...
<script>
    $(document).ready(function() {
            validateInput(['#username','#password'], 'Vui lòng nhập trường này');
            $('#create').submit(function(e) {
                let fieldIds = ['username','password']
