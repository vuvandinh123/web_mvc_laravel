...
@section('title', 'Admin | Thùng rác thương hiệu')
@section('crumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="{{ route('dashboard') }}">Admin</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Thùng rác thương hiệu</li>
        </ol>
    </nav>
@endsection
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <h6 class="fs-4 text-capitalize text-danger">Thùng rác thương hiệu</h6>
                        <div></div>
                    </div>
                          ...
                          @else
                              {{ $brand->image }} @endif
                                            ...
                                            <td class="align-middle">
                                                <span style="cursor: pointer" data-id="{{ $brand->id }}"
                                            ...
                                            <td class="align-middle ">
                                                    ...
                                                    <input type="checkbox" value="{{ $brand->id }}" class="destroys" name="destroy[]" id="">
