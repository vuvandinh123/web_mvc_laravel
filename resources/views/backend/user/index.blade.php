...
@section('crumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Khách hàng</li>
        </ol>
    </nav>
@endsection
@section('content')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <a class="btn " href="{{ route('user.create') }}">THÊM</a>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                                    ...
                                    @foreach ($listUser as $user)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <i style="cursor: pointer" data-id="{{ $user->id }}"
                                                    class="setStatus p-2 fa-solid text-success fs-4 @if ($user->status == 2) fa-toggle-on
                        @else fa-toggle-off @endif"></i>
                                                ...
                                                <a class="py-2 delete" data-id="{{ $user->id }}"
                                            ...
                                            <td class="align-middle ">
                                                <a href="" class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip" data-original-title="Edit user">
                                                    <input value="{{ $user->id }}" type="checkbox" class="deletes"
                                                        name="" id="">
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <ul style="list-style: none;" class="d-flex mt-3">
                                ...
                                <li class="mx-2  "><button id="btnDelete" class="text-danger"
                                        style="border:none;background: none;">Thêm vô thùng rác <i
                                            class="fa-regular fa-trash-can"></i></button></li>
                                <li class="mx-2"> <a class="text-success" href="{{ route('user.create') }}">Tạo mới</a>
                                </li>

                            </ul>
                            <p class="text-center"></p>

                            <a href="{{ route('user.trash') }}" class="float-end btn my-3" type="submit">Thùng rác</a>
                        </div>
                    </div>
                </div>
            </div>
