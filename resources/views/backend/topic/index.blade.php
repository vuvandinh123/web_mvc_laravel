...
@section('crumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Chủ đề bài viết</li>
        </ol>
    </nav>
@endsection
@section('content')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <h6>Chủ đề bài viết</h6>
                        <a class="btn " href="{{ route('topic.create') }}">THÊM</a>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                                    ...
                                    @foreach ($listTopic as $topic)
                                        <tr>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">
                                                            <a href="{{ route('topic.show',['topic'=>$topic->id]) }}">{{ $topic->name }}
                                                            </a>
                                                            </h6>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="align-middle">
                                                <i style="cursor: pointer" data-id="{{ $topic->id }}"
                                                    class="setStatus p-2 fa-solid text-success fs-4 @if ($topic->status == 2) fa-toggle-on
                        @else fa-toggle-off @endif"></i>
                                                ...
                                                <a class="py-2 delete" data-id="{{ $topic->id }}"
                                            ...
                                            <td class="align-middle ">
                                                <a href="" class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip" data-original-title="Edit user">
                                                    <input type="checkbox" value="{{ $topic->id }}" class="deletes" name="" id="">
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
