    ...
    <a href="{{ route('product.index') }}" class="fs-6">Quay lại</a>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input name="name" type="text" required class="form-control" placeholder="Tên sản phẩm">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" placeholder="ví dụ: sản phẩm đến từ tương lai" required class="form-control" name="qty" id="" >
            </div>
            
            <div class="col-md-6">
                <label for="" class="form-label my-2">Giá</label>
                <input placeholder="ví dụ: 10000" required class="form-control" name="price" id="" >
            </div>
            <div class="col-md-6">
                <label for="" class="form-label my-2">Từ khóa tìm kiếm</label>
                <input type="text" placeholder="ví dụ: sản phẩm đến từ tương lai" required class="form-control" name="metakey" id="" >
            </div>
            <div class="col-md-6">
                <label for="" class="form-label my-2">Phần trăm khuyến mại (nếu có)</label>
                <input type="text" placeholder="ví dụ: 10" required class="form-control" name="pricesale" id="" >
            </div>
